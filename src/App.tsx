...
const copy = {
  ru: {
    ...
    academyKicker: '03 / Выберите свой путь', academyTitle: 'АКАДЕМИЯ', academyLead: 'Знание превращает хаос боя в систему. Выберите свой уровень — и начните путь к следующему рангу.', academyHelp: 'Не знаете свой уровень? Пройдите короткий тест →',
    levels: [
  ...
  en: {
    ...
    academyKicker: '03 / Choose your path', academyTitle: 'ACADEMY', academyLead: 'Knowledge turns the chaos of battle into a system. Choose your level and begin the climb to your next rank.', academyHelp: 'Not sure of your level? Take the short test →',
    levels: [
